...
def addall():
    ...
    quiz_places.save()
    module_places = Module(module_name='Places', details='In this module you will learn the signs for common places', words=[house,museum,restaurant,city,restroom,store,park,kitchen], parent=objectsId('5db21f18019bf84707b3a746'), quiz=[quiz_places])
    module_places.save()
    ...
    question_meat.save()
    vegetable = Dictionary.objects.get(word='vegetables')
